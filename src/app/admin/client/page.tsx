              ...
              {clients
                .filter((client) => {
                  ...
                  return (
                    ...
                    client.membership_number?.toLowerCase().includes(term) ||
                ...
                .map((client) => (
                  ...
                  >
                    <td className="p-3 border-b">{client.membership_number}</td>
                    <td className="p-3 border-b">{client.client_name}</td>
                    <td className="p-3 border-b">{client.CNIC}</td>
                    <td className="p-3 border-b">{client.apartment_info}</td>
                    <td
